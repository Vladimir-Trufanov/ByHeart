## POWERS, элементы и модули питания

---

### [Аккумулятoрная плата расширения MINGYUANDINGYE и 4  литиевых батареи Daweikala 18650](#%D0%B0%D0%BA%D0%BA%D1%83%D0%BC%D1%83%D0%BB%D1%8F%D1%82%D0%BE%D1%80%D0%BD%D0%B0%D1%8F-%D0%BF%D0%BB%D0%B0%D1%82%D0%B0-%D1%80%D0%B0%D1%81%D1%88%D0%B8%D1%80%D0%B5%D0%BD%D0%B8%D1%8F-mingyuandingye-%D0%B8-4-%D0%BB%D0%B8%D1%82%D0%B8%D0%B5%D0%B2%D1%8B%D1%85-%D0%B1%D0%B0%D1%82%D0%B0%D1%80%D0%B5%D0%B8-daweikala-18650)

---


### Аккумуляторная плата расширения MINGYUANDINGYE и 4 литиевых батареи Daweikala 18650

> ***Аккумуляторная плата расширения MINGYUANDINGYE - 2025-03-19 в [
> Simple Robot Store](https://aliexpress.ru/store/716258?spm=a2g2w.detail.0.0.76d7b9c5zolOZ5) доставлена за 12 дней***

![](MINGYUANDINGYE.webp)

- 100мм x 91 мм;
- защита аккумулятора (перезарядка или переразрядка);
- вход с порта Micro USB;
- USB-выход типа А;
- токовая зарядка 0,5 А;
- USB-выход управляется переключателем;
- входное напряжение 5 ~ 8 В;
- выход 3В и 1А;
- выход 5В и 2А;
- выходной порт 3В x 5;
- выходной порт 5В x 5.

> ***В полностью заряженном приборе горят 4 светодиода красным цветом. Во время зарядки разряженного прибора число горящих светодиодов постепенно увеличивается по степени заряженности прибора, от одного до четырех. Пока прибор не заряжен полностью один светодиод мигает.***

Будьте осторожны на «+» и «-», следует следовать направлению «+»»-» на печатной плате. Если вы указали неправильное направление, чип зарядки будет уничтожен.

В режиме NORMAL отключается примерно через 30 секунд, в режиме HOLD отдает ток всегда и светятся светодиоды на задней стороне. Некоторые зарядки типа GAN не видят этот шилд и отказываются заряжать.

Эти модули имеют переключатель, который настраивает режим выключения: по потребителю или по долгому нажатию кнопки. Включение осуществляется коротким нажатием кнопки. Выводы питания 5v, 3v3, usb отключаются и включаются вместе, есть 4 диода индикации заряда и заряженности.

Robert M. 19 июня 2024: если вы покупаете его для управления удаленным устройством esp32/esp8266, не покупайте. Переключатели "NORMAL" и "HOLD" изменяют режим работы батарейного платы. В "НОРМАЛЬНОМ" режиме плата выключается по истечении установленного времени при низком напряжении (т.е. если esp находится в режиме глубокого сна). В режиме "ОЖИДАНИЯ" устройство остается включенным, однако для этого в цепь добавляется резистивная нагрузка, чтобы "обмануть" плату, заставив её думать, что что-то потребляет энергию. Это быстро разряжает батареи. На самом деле не подходит для приложений ESP32 / ESP8266.

> ***Литиевые батареи Daweikala 18650 - 2025-04-04 в [Shop1104035437 Store](https://aliexpress.ru/store/1104035437?spm=a2g2w.detail.0.0.141c7162l23cOt) доставлена за 23 дня***

![](DAWeiKALA.webp)

- Daweikala новый оригинальный 3,7 v 18650 35E 3500mAh литиевая батарея с непрерывной разрядкой 30A, подходит для игрушек с электроинструментами БПЛА;
- модель: 35E;
- емкость: 3500 mAh;
- внутреннее сопротивление:<30 мОм;
- количество зарядок: 1200 раз;
- напряжение аккумулятора: стандартное 3.7V;
- напряжение 4,2V после зарядки;
- напряжение 2,5V при разрядке;
- оснащен взрывозащищенным клапаном.

Примечание:

1. Не ждите разрядки аккумулятора перед зарядкой. Литиевые батареи отличаются от обычных батарей. Зарядка аккумулятора перед использованием не способствует здоровью литиевых батарей. Аккумулятор может быть разряжен.

2. Не подвергайте литиевую батарею воздействию высокой температуры. Литиевые батареи предпочитают места с более низкой температурой.

3. Краткое описание метода подзарядки: короткая зарядка и короткая зарядка (не часто, если вы не хотите торопиться!).

4. Заряжайте при падении мощности до 10% ~ 20%.

5. Используйте высококачественное специальное зарядное устройство для литиевых батарей с функцией защиты.

5. В низкотемпературной среде срок службы литиевой батареи будет значительно сокращен. Это нормально. Он восстановится в теплом месте примерно через час.
...
> ***Во время зарядки горит красный светодиод. Когда прибор полностью заряжен загорается зелёный светодиод.***
