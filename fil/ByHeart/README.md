## ByHeart
<razdel>Транзисторы<razdeli>

The background color is '#fffeee' for light mode and "#000000" for dark mode.

<style>
razdel{color:green; font-weight:700; font-size:30px}
razdel{color:#ab4a16; font-weight:700; font-size:1.5rem}
red { color: red }
yellow { color: yellow }
</style>
...
### [0. Пробуем ноты на Arduino](#probuem-noty-na-arduino)
### [ESP32-CAM, библиотека и примеры для версии 1.0.6](esp32v106/README.md)
### [Занятие 2.  Занятие для отладки схемы документации](#zanyatie-dlya-otladki-shemy)
### [Занятие 3. Вложенное занятие для отладки схемы](SimaMark3/SimaMark3.html)
### [4. Заставляем ESP32-CAM мигать лампочками](#zastavlyaem-migat-lampochkami-esp32-cam)
...
![img](/Electronics/Transistors/transistors-1.png)
...
![img](/Electronics/Transistors/transistors-npn-pnp.png)
...
![img](/Electronics/Transistors/transistors-2.png)

### N-Channel и P-Channel

По аналогии с биполярными транзисторами, полевые различаются полярностью. Выше был описан N-Channel транзистор. Они наиболее распространены.

![img](/Electronics/Transistors/transistors-mos-np.png)
...
![img](/Electronics/Transistors/transistors-3.png)
...
![img](/Electronics/Transistors/fetch0.png)
...
![img](/Electronics/Transistors/fetch1.png)
...
![img](/Electronics/Transistors/transistors-4.png)

это связано с тем, что затвор в таких транзисторах управляется исключительно напряжением: ток на участке микроконтроллер — затвор — исток отсутствует. А благодаря своим высоким характеристикам схема с использованием MOSFET позволяет управлять очень мощными компонентами.


##### [-IRL530NPBF](#IRL530NPBF)


### Транзисторы

##### IRL530NPBF
![img](/Electronics/Transistors/IRL530NPBF.jpg)
