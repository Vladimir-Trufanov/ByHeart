 ...
 *
 Простой пример передачи данных с 6 приемопередатчиков nRF24L01 на 1 принимающий 
 приемопередатчик. Этот метод является торговой маркой Nordic Semiconductors под 
 названием "MultiCeiver".
