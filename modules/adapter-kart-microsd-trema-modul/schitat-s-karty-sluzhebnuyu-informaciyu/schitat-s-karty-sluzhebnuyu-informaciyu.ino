// **************************** schitat-s-karty-sluzhebnuyu-informaciyu.ino ***
// *                                                                          *
// * Считать с карты служебную информацию: тип карты, тип файловой системы,   *
// * размер первого раздела и список файлов на нём.                           *
// * https://robotclass.ru/tutorials/arduin-read-write-micro-sd-card/         *
// *                                                                          *
// * v1.0.1, 16.05.2026                            Автор:       Труфанов В.Е. *
// * Copyright © 2026 tve                          Дата создания:  09.04.2026 *
// ****************************************************************************
