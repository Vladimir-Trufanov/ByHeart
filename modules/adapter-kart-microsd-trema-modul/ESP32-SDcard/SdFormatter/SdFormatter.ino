...
/*
  Установите значение DISABLE_CS_PIN, чтобы отключить второе устройство SPI.
  Например, для экрана Ethernet установите значение DISABLE_CS_PIN
  равным 10, чтобы отключить контроллер Ethernet.
*/
const int8_t DISABLE_CS_PIN = -1;
/*
  Измените значение SD_CS_PIN, если вы используете SPI
  и ваше оборудование не использует значение по умолчанию, SS.
